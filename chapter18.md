...
The following sections are informative only. It contains mathematics pertaining to the
representation of ellipses that may be of use to implementers. Some of the material is
adapted from [[SVGF04](#SVGF04)]
...
$$
An ellipse in the center parameterization may be viewed as a unit circle, parameterized
as $(x, y) = (\cos{\theta}, \sin{\theta})$ that has been placed through an affine transformation
consisting of a rotation and a non-uniform scale:
$$
...
As previously noted, an ellipse may be viewed as the result of a scale, rotation, and
translation applied to the unit circle:
$$
